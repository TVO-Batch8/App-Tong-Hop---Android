...
public class FragmentNews_MyAdapter extends BaseAdapter {
	Context mContext;
	ArrayList<FragmentNews_OneItemInLvMenu> alItem;
	...
	public FragmentNews_MyAdapter(Context c,
			ArrayList<FragmentNews_OneItemInLvMenu> ds) {
		this.mContext = c;
		this.alItem = ds;
		// SetFont();
		// SetColor();
