...
public class Activity_ReadBook extends Activity implements OnClickListener {
	// setting
	...
	private FacebookCallback<Sharer.Result> shareCallback = new FacebookCallback<Sharer.Result>() {
		...
		private void showResult(String title, String alertMessage) {
			new AlertDialog.Builder(Activity_ReadBook.this).setTitle(title)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// anh xa
		setContentView(R.layout.menu_fragment_book_read_book);
		...
		// co so du lieu
		// qlb = new Dtb_BookSavedManager(Activity_ReadBook.this);
	...
	public class myWebClient extends WebViewClient {
		...
		public boolean shouldOverrideUrlLoading(WebView view, String url) {
			...
			Log.d("mLink", mLink);
			if (url.contains("://linkhay.com/submit")) {
				// goi intentShare - chuc nang share
				intentShare();
			} else if (url.contains("://link.apps.zing.vn/share?u=")) {
				...
				new Thread(new Runnable() {
					public void run() {
						...
						try {
							...
							// div[class=content]
							// Elements newsRawTag =
							// doc.select("div#maincontent");
							// Elements newsRawTag = doc.select("p");

							// Elements newsRawTag = doc.select(
							// "div[class=maincontent]").select(
							// "div[class=content]");
	...
	public void onClick(View v) {
		...
		// Log.d("all", mFiles.get(i).toString());
		// }
		//
		...
		// //
		// String tmpLink = "/storage/emulated/0/GiaiTriTongHopBook/"
		// + tmpTilte;
		// Log.d("check", tmpLink);
